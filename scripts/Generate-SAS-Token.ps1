...
#
$subscriptionId = "39b6762f-8025-4390-b534-c43b14928d62"    # Replace with Azure Subscription Id
$resourceGroupName = "AzureDayRomeResourceGroup"            # Replace with your Resource Group name
$namespaceName = "AzureDayRomeEventHubsNamespace"           # Replace with your Event Hub Namespace name
$eventHubName = "orderseventhub"                            # Replace with your Event Hubs instance name
$policyName = "AzureDayRomePolicy"                          # Replace with the policy name
